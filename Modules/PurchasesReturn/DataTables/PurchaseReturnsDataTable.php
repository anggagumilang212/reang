...
class PurchaseReturnsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('product_names', function ($data) {
                ...
                return $data->purchaseReturnDetails->map(function ($detail) {
    ...
    {
        $query = $model->newQuery()->with(['branch', 'purchaseReturnDetails.product'])->orderBy('created_at', 'desc');;
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('supplier_name')
                ->title(__('messages.suppliername'))
                ->className('text-center align-middle'),
