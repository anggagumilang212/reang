    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            @foreach ($branches as $branch)
                <div class="relative">
                    <div
                        class="border-2 border-transparent hover:border-blue-500 rounded-lg shadow-lg transition-all duration-300 bg-white p-6 cursor-pointer h-full flex flex-col items-center">
                        <div class="flex justify-center items-center mb-4">
                            <i class="c-sidebar-nav-icon bi bi-shop-window text-5xl text-blue-500 mb-4"
                        ...
                        <form action="{{ route('branch.set') }}" method="POST"
                            class="absolute bottom-6 left-0 right-0 px-6">
                            @csrf
