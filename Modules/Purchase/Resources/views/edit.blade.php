...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('purchases.index') }}">{{ __('messages.purchases') }}</a></li>
                        ...
                        <form id="purchase-form" action="{{ route('purchases.update', $purchase) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="branch_id" id="branch_id" required>
                                                @foreach (\Modules\Branch\Entities\Branch::all() as $branch)
                                                    <option {{ $purchase->branch_id == $branch->id ? 'selected' : '' }}
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('messages.update') }} {{ __('messages.purchases') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
