...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('messages.edit') }} {{ __('messages.payment') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('messages.update') }} {{ __('messages.payment') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="due_amount">{{ __('messages.dueamount') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="amount" type="text" class="form-control" name="amount" required value="{{ $salePayment->amount }}">
