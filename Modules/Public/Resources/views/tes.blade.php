...
<body class="bg-[#F1F4F5] font-['Poppins'] ">
    <nav class="navbar max-w-6xl mx-auto py-10 px-5 md:px-8 xl:px-0">
        <div class="flex flex-row items-center justify-between">
            <img src="assets/logo-light.svg" class="h-[42px]" alt="">
            <ul class=" flex-row gap-x-8 lg:flex hidden">
                <li><a href="#" class="text-indigo-950 hover:text-violet-700">Products</a></li>
                <li><a href="#" class="text-indigo-950 hover:text-violet-700">Services</a></li>
                <li><a href="#" class="text-indigo-950 hover:text-violet-700">Pricing</a></li>
                <li><a href="#" class="text-indigo-950 hover:text-violet-700">Testimonials</a></li>
                <li><a href="#" class="text-indigo-950 hover:text-violet-700">Blog</a></li>
            </ul>
            <div class="flex flex-row gap-x-4">
                ...
                <a href="#"
                    class="md:block hidden py-3 bg-indigo-950 text-white text-base px-5 rounded-full hover:bg-violet-700 transition duration-500">
                    Sign In
                </a>
    ...
    <div id="dropdown-menu"
        ...
        <div class="flex flex-col bg-white p-5 md:p-8 rounded-2xl gap-y-5">
            ...
            <a href="#"
                class="md:hidden py-3 bg-indigo-950 text-white text-base px-5 text-center w-full rounded-full">
                Sign In
            </a>
        </div>
    ...
    <section class="hero max-w-6xl md:px-8 px-4 mx-auto  xl:px-0">
        ...
        <div class="flex flex-col gap-y-10 md:flex-row md:justify-between items-center">
            <div class="gap-y-10 flex flex-col md:basis-2/4 lg:basis-3/6">
                ...
                <div class="flex flex-col lg:flex-row gap-x-5 gap-y-5 items-center">
                    <a href="#"
                        class="w-full text-center lg:w-fit transition-all ease-in-out duration-500 hover:bg-indigo-950 bg-violet-700 px-10 py-4 rounded-full text-white text-lg font-semibold">
                        Try Free Trial
                    </a>
                    <a href="#" class="font-semibold text-violet-700 flex gap-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                            ...
                            <path
                                ...
                                stroke="#640EF1" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M7.89999 22H15.1" stroke="#640EF1" stroke-width="2" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.5 18.4V22" stroke="#640EF1" stroke-width="2" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M18.9955 7.25H19.0045" stroke="#640EF1" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M16.1957 7.25H16.2047" stroke="#640EF1" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M13.3954 7.25H13.4044" stroke="#640EF1" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        Schedule a Demo
                    </a>
            ...
            <div class="flex items-center flex-col">
                <img src="assets/illustration-hero.png" class="h-[397px] md:basis-2/4 lg:h-[550px]" alt="">
            </div>
        </div>
    </section>
    <section class="brands max-w-6xl mx-auto py-12">
        <div class="flex flex-col gap-y-10 md:px-8 md:gap-y-0 items-center md:flex-row gap-x-10 justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="140" height="34" viewBox="0 0 140 34"
                ...
                <g clip-path="url(#clip0_1_399)">
                    ...
                    <path
                        d="M56.8798 21.8874C55.4667 21.8874 54.7303 20.6534 54.7303 18.8025C54.7303 16.9516 55.4667 15.6977 56.8798 15.6977C58.2929 15.6977 59.0492 16.9516 59.0492 18.8025C59.0492 20.6534 58.2929 21.8874 56.8798 21.8874ZM56.8997 24.1961C60.1836 24.1961 62.3331 21.8675 62.3331 18.8025C62.3331 15.7375 60.1836 13.4089 56.8997 13.4089C53.6357 13.4089 51.4464 15.7375 51.4464 18.8025C51.4464 21.8675 53.6357 24.1961 56.8997 24.1961Z"
                        fill="#080C2E" />
                    <path
                        ...
                        fill="#080C2E" />
                    <path
                        d="M79.4963 21.8874C78.0832 21.8874 77.3468 20.6534 77.3468 18.8025C77.3468 16.9516 78.0832 15.6977 79.4963 15.6977C80.9094 15.6977 81.6656 16.9516 81.6656 18.8025C81.6656 20.6534 80.9094 21.8874 79.4963 21.8874ZM79.5162 24.1961C82.8001 24.1961 84.9498 21.8675 84.9498 18.8025C84.9498 15.7375 82.8001 13.4089 79.5162 13.4089C76.2522 13.4089 74.0629 15.7375 74.0629 18.8025C74.0629 21.8675 76.2522 24.1961 79.5162 24.1961Z"
                        fill="#080C2E" />
                    <path
                        d="M85.8968 23.8776H89.1409V13.6876H85.8968V23.8776ZM85.8968 12.2745H89.1409V9.64737H85.8968V12.2745Z"
                        fill="#080C2E" />
                    <path
                        d="M90.5482 27.2411H93.7923V22.8228H93.8321C94.469 23.6786 95.4044 24.1961 96.7179 24.1961C99.3849 24.1961 101.156 22.0864 101.156 18.7826C101.156 15.7176 99.5043 13.389 96.7976 13.389C95.4044 13.389 94.4093 14.006 93.7127 14.9215H93.653V13.6876H90.5482V27.2411ZM95.882 21.6884C94.4889 21.6884 93.6928 20.5539 93.6928 18.902C93.6928 17.2501 94.4093 15.9963 95.8223 15.9963C97.2155 15.9963 97.8723 17.1506 97.8723 18.902C97.8723 20.6335 97.116 21.6884 95.882 21.6884Z"
                        fill="#080C2E" />
                    <path
                        d="M106.439 24.1961C109.106 24.1961 111.076 23.0417 111.076 20.8126C111.076 18.2054 108.966 17.7477 107.175 17.4491C105.881 17.2103 104.727 17.1108 104.727 16.3943C104.727 15.7574 105.344 15.4589 106.14 15.4589C107.036 15.4589 107.653 15.7375 107.772 16.653H110.757C110.598 14.6429 109.046 13.389 106.16 13.389C103.752 13.389 101.762 14.5036 101.762 16.653C101.762 19.0413 103.652 19.519 105.424 19.8175C106.777 20.0564 108.011 20.1559 108.011 21.0714C108.011 21.7282 107.394 22.0864 106.419 22.0864C105.344 22.0864 104.667 21.5888 104.548 20.5738H101.483C101.582 22.8228 103.453 24.1961 106.439 24.1961Z"
                        fill="#080C2E" />
                    <path
                        d="M115.482 24.1761C116.895 24.1761 117.79 23.6189 118.527 22.6238H118.587V23.8776H121.691V13.6876H118.447V19.3797C118.447 20.5937 117.771 21.4296 116.656 21.4296C115.621 21.4296 115.124 20.8126 115.124 19.6981V13.6876H111.899V20.3748C111.899 22.6437 113.133 24.1761 115.482 24.1761Z"
                        fill="#080C2E" />
                    <path
                        d="M123.103 23.8776H126.347V18.1656C126.347 16.9516 126.944 16.0958 127.959 16.0958C128.934 16.0958 129.392 16.7326 129.392 17.8273V23.8776H132.636V18.1656C132.636 16.9516 133.213 16.0958 134.248 16.0958C135.223 16.0958 135.681 16.7326 135.681 17.8273V23.8776H138.925V17.2501C138.925 14.9613 137.771 13.389 135.462 13.389C134.149 13.389 133.054 13.9463 132.258 15.1803H132.218C131.701 14.0856 130.686 13.389 129.352 13.389C127.879 13.389 126.904 14.0856 126.267 15.1405H126.208V13.6876H123.103V23.8776Z"
                        fill="#080C2E" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M7.94491 3.22709C6.75851 4.05666 5.68568 5.03748 4.75437 6.14158C8.56014 5.78826 13.3952 6.3652 19.0087 9.17196C25.0031 12.1691 29.8302 12.2704 33.1895 11.6224C32.8847 10.6996 32.5009 9.81257 32.0464 8.96937C28.2008 9.37497 23.2708 8.8381 17.5253 5.96543C13.8769 4.14121 10.6608 3.38975 7.94491 3.22709ZM29.8 5.77194C26.7631 2.37886 22.3498 0.2435 17.4377 0.2435C15.9952 0.2435 14.5956 0.427686 13.2613 0.7738C15.0684 1.26689 16.9882 1.98827 19.0087 2.99855C23.2152 5.10179 26.8469 5.77899 29.8 5.77194ZM33.9077 14.8619C29.8493 15.6633 24.245 15.4987 17.5253 12.1388C11.2431 8.99773 6.243 9.03729 2.87076 9.7867C2.69669 9.82534 2.52673 9.86598 2.36087 9.90827C1.91935 10.8685 1.56693 11.8782 1.31406 12.9267C1.58414 12.8546 1.86322 12.786 2.15117 12.722C6.24229 11.8128 12.0227 11.8523 19.0087 15.3454C25.291 18.4865 30.2911 18.4469 33.6634 17.6975C33.7789 17.6719 33.8927 17.6453 34.0047 17.618C34.017 17.3565 34.0231 17.0934 34.0231 16.8288C34.0231 16.1634 33.984 15.507 33.9077 14.8619ZM33.4632 21.1181C29.4441 21.8207 24.0031 21.551 17.5253 18.3122C11.2431 15.1711 6.243 15.2107 2.87076 15.9601C2.12222 16.1264 1.44884 16.329 0.854831 16.5428C0.853212 16.6379 0.852402 16.7333 0.852402 16.8288C0.852402 25.9887 8.27791 33.4142 17.4377 33.4142C25.1144 33.4142 31.5729 28.1989 33.4632 21.1181Z"
                        fill="#080C2E" />
                </g>
                <defs>
    ...
    <section class="benefits max-w-6xl mx-auto py-12 md:px-8 px-4 xl:px-0">
        <h3 class="text-[34px] md:text-5xl text-indigo-950 font-['Clash_Display'] text-center font-bold mb-10">
            Your Best Choice
        </h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-7 gap-y-8">
            <div class="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
                ...
                <a href="#" class="text-violet-700 font-semibold">
                    Learn More
                </a>
            </div>
            <div class="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
            ...
            <div class="item-card bg-[#080C2E] relative rounded-2xl p-7 gap-y-7 flex flex-col">
                <div class="absolute right-10 w-fit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="178" height="221" viewBox="0 0 178 221"
                        fill="none">
                ...
                <div class="z-10 gap-y-7 flex flex-col">
                    ...
                    <div>
                        <h3 class="font-semibold text-white text-xl mb-2">
                            AI Automation
                        </h3>
                        <p class="text-base leading-lg text-gray-500">
            ...
            <div class="item-card bg-white rounded-2xl p-7 gap-y-7 flex flex-col">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="46" viewBox="0 0 47 46"
                    ...
                    <path d="M19.6667 11.9792V15.8125" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M12 30.6667V34.5" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                        stroke-linejoin="round" />
    ...
    <section class="max-w-6xl mx-auto py-12 md:px-8 px-4 xl:px-0">
        <div class="flex flex-col md:flex-row gap-y-10 justify-start gap-x-10 lg:gap-x-24">
            <div class="flex items-center flex-col">
                <img src="assets/illustration-features.png" class="h-[360px] lg:h-[550px]" alt="">
            </div>
            <div class="flex flex-col text-left gap-y-10 basis-2/4">
                <div>
                    <h3
                        class="leading-tight md:leading-lg text-[34px] lg:text-5xl text-indigo-950 font-['Clash_Display'] font-bold mb-5">
                        We Have Very<br class="hidden lg:block">
                        Strong Ecosystem
                    </h3>
                    <p class=" text-base leading-lg text-gray-500">
                    ...
                    <div class="flex bg-white rounded-2xl p-5 items-center gap-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="46" viewBox="0 0 47 46"
                            ...
                            <path
                                ...
                                stroke="#640EF1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.8525 7.66671V3.83337" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M23.5 7.66671V3.83337" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M31.1667 7.66671V3.83337" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M38.8333 15.3334H42.6667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M38.8333 23H42.6667" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M38.8333 30.6666H42.6667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M31.1667 38.3334V42.1667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M23.5192 38.3334V42.1667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.8525 38.3334V42.1667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M4.33334 15.3334H8.16667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M4.33334 23H8.16667" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M4.33334 30.6666H8.16667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
                    ...
                    <div class="flex bg-white rounded-2xl p-5 items-center gap-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="46" viewBox="0 0 47 46"
                            ...
                            <path d="M11.1183 21.3132C2.14827 21.9457 2.14827 34.9982 11.1183 35.6307H14.7984"
                                stroke="#640EF1" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                            ...
                            <path
                                ...
                                stroke="#640EF1" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M20.51 31.6825L22.4075 33.58L26.49 29.8042" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <div>
                            <h3 class="font-bold text-xl">
                ...
                <div class="flex flex-col gap-y-5 lg:flex-row gap-x-5 items-center">
                    <a href="#"
                        class="w-full text-center lg:w-fit transition-all ease-in-out duration-500 hover:bg-indigo-950 bg-violet-700 px-10 py-4 rounded-full text-white text-lg font-semibold">
                        Explore More
                    </a>
    ...
    <section class="mx-auto py-12 md:px-8 px-4 xl:px-0">
        <div class="flex flex-col gap-y-7">
            <div class="flex flex-col text-center">
                ...
                <p class="text-base leading-lg text-gray-500">
                    They built amazing website to help more people around the world<br class="hidden md:block">
            ...
            <div class="flex flex-wrap gap-y-8 lg:flex-row justify-center gap-x-7 items-center">
                <div class="group relative ">
                    <div
                        ...
                        <a href="#"
                            class="transition-all ease-in-out duration-500 shadow-2xl shadow-violet-700 hover:bg-indigo-950 hover:text-white bg-violet-700 px-7 py-3 font-semibold rounded-full text-white text-base">
                            View Details
                        </a>
                    </div>
                    <img src="assets/showcase1.png" alt=""
                        class="w-[320px] h-[220px] border-0 group-hover:border-4 border-violet-700 rounded-[16px] transition-all ease-in-out duration-500">
                </div>
                <div class="group relative ">
                    <div
                        class="group-hover:opacity-100 transition-all ease-in-out duration-500 absolute opacity-0 bottom-8 justify-center flex w-full">
                        <a href="#"
                            class=" transition-all ease-in-out duration-500shadow-2xl shadow-violet-700 hover:bg-indigo-950 hover:text-white bg-violet-700 px-7 py-3 font-semibold rounded-full text-white text-base">
                            View Details
                        </a>
                    </div>
    ...
    <section class="max-w-6xl mx-auto ">
        <div
            class="promotion mx-4 md:mx-8 xl:mx-0 rounded-3xl bg-violet-700 mt-20 md:relative z-20  py-12 md:px-8 px-4 xl:px-10">
            <div class="grid lg:grid-cols-2 gap-x-8 gap-y-10 items-center">
                <div class="flex flex-col gap-y-10">
                    ...
                    <div>
                        ...
                        <p class="text-base leading-loose text-white">
                            We provide a variety of servers to grow your users<br class="md:block hidden">
                            acquisition much user-friendly and boosting up sales.
                        </p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-x-5 items-center gap-y-5">
                        <a href="#"
                            class="w-full sm:w-fit text-center transition-all ease-in-out duration-500 hover:text-white hover:bg-indigo-950 bg-[#FFD15A] px-10 py-4 rounded-full text-indigo-950 text-lg font-semibold">
                            Get Started
                        </a>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 sm:grid-cols-2 gap-x-5 gap-y-5">
                    <div class="bg-white rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="46" viewBox="0 0 47 46"
                            fill="none">
                            <path
                    ...
                    <div class="bg-white rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="46" viewBox="0 0 47 46"
                            ...
                            <path
                                ...
                                stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M15.8525 7.66659V3.83325" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M23.5 7.66659V3.83325" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M31.1667 7.66659V3.83325" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M38.8333 15.3333H42.6667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M38.8333 23H42.6667" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M38.8333 30.6667H42.6667" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M31.1667 38.3333V42.1666" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M23.5192 38.3333V42.1666" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.8525 38.3333V42.1666" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M4.33334 15.3333H8.16668" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M4.33334 23H8.16668" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M4.33334 30.6667H8.16668" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
                    ...
                    <div class="group">
                        <div
                            class="group-hover:bg-[#080C2E] transition ease-in-out duration-500 group-hover:py-[28px] group-hover:cursor-pointer transition bg-white relative rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                            <div class="group-hover:flex hidden absolute right-3 top-3 w-fit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="92" height="126"
                                    viewBox="0 0 92 126" fill="none">
                                    ...
                                    <defs>
                                        <filter id="filter0_f_11_2611" x="0.459412" y="0.738525" width="90.8846"
                                            height="124.49" filterUnits="userSpaceOnUse"
                            ...
                            <div class="z-10 flex flex-col gap-y-5 items-center">
                                <svg class="group-hover:block hidden transition-all ease-in-out duration-500"
                                ...
                                <svg class="group-hover:hidden" width="47" height="47"
                                ...
                                <div class="text-center">
                                    <h3
                                        class="text-indigo-950 group-hover:text-white font-bold text-lg transition-all ease-in-out duration-500">
                                        Anti-DDoS
                                    </h3>
                                    <a href="#" class="hidden group-hover:block text-base text-gray-500">
                                        Learn More
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.02 35.2876V31.3201" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" />
                            <path d="M23.8333 35.2875V27.3525" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" />
                            <path d="M33.6467 35.2874V23.3657" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" />
                            <path d="M33.6467 11.7124L32.765 12.7474C27.8775 18.4591 21.3225 22.5032 14.02 24.3241"
                                stroke="#640EF1" stroke-width="3" stroke-linecap="round" />
                            <path d="M28.0308 11.7124H33.6467V17.3091" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
                    ...
                    <div class="bg-white rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.9583 42.6667V29.25" stroke="#640EF1" stroke-width="3"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.9583 10.0833V4.33325" stroke="#640EF1" stroke-width="3"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M34.0417 42.6667V36.9167" stroke="#640EF1" stroke-width="3"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M34.0417 17.7499V4.33325" stroke="#640EF1" stroke-width="3"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                    ...
                    <div class="bg-white rounded-2xl flex py-5 md:py-[40px] h-fit flex-col gap-y-5 items-center">
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none"
                            ...
                            <path
                                ...
                                stroke="#640EF1" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M12.625 42.6667H33.7083" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M18.375 27.3333H27.9583" stroke="#640EF1" stroke-width="3"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
    ...
    <section class="footer w-screen bg-[#080C2E] lg:-z-10 lg:-mt-[230px] lg:pt-[230px] h-fit">
        <div class="max-w-6xl mx-auto mt-[100px] px-5 py-10 lg:py-0 xl:px-0">
            <div class="grid lg:grid-cols-5 gap-x-10 gap-y-8 grid-cols-1 sm:grid-cols-2">
                <div class="lg:col-span-2 flex flex-col gap-y-8">
                    <img src="assets/logo.svg" alt="" class="w-fit h-[42px]">
                ...
                <div class="flex flex-col gap-y-8">
                    ...
                    <ul class="gap-y-4 flex flex-col">
                        <li>
                            <a href="#" class="text-gray-400 hover:text-violet-300">Powerful Reports</a>
                        </li>
                        <li>
                            <a href="#" class="text-gray-400 hover:text-violet-300">Blockchain</a>
                        </li>
                        <li>
                            <a href="#" class="text-gray-400 hover:text-violet-300">Auto-Backup</a>
                        </li>
                        <li>
                            <a href="#" class="text-gray-400 hover:text-violet-300">Data Science</a>
                        </li>
                        <li>
                            <a href="#" class="text-gray-400 hover:text-violet-300">Auto-Scaling Up</a>
                        </li>
                    </ul>
                </div>
                <div class="flex flex-col gap-y-8">
            ...
            <p class="py-20 text-center text-base text-gray-400">
                All Rights Reserved • Copyright Weserve by <a href="https://buildwithangga.com/"
