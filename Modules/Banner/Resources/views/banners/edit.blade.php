...
@section('content')
    <div class="container-fluid mb-4">
        <form id="product-form" action="{{ route('banners.update', $Banner->id) }}" method="POST"
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{__('messages.update')}} {{__('messages.banner')}} <i class="bi bi-check"></i></button>
                    </div>
                </div>
