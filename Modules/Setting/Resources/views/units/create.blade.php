...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('units.index') }}">{{__('messages.unit')}}</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="operator">{{__('messages.operator')}}</label>
                                        <input type="text" class="form-control" name="operator" placeholder="ex: * / + -">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="operation_value">{{__('messages.operation_value')}}</label>
                                        <input type="text" class="form-control" name="operation_value" placeholder="Enter a number">
                                    </div>
                                </div>
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        <button class="btn btn-primary">{{__('messages.create')}} <i class="bi bi-check"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
