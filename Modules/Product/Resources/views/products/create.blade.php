            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('messages.createproduct') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="product_slug" type="text" class="form-control" name="product_slug"
                                            readonly required placeholder="Auto Generated"
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_order_tax">{{ __('messages.tax') }} (%)</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            <option value="" selected>{{ __('messages.select') }} {{ __('messages.taxtype') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_unit" id="product_unit">
                                            <option value="" selected>{{ __('messages.select') }} Unit</option>
                            ...
                            {{-- <div class="form-group">
                                <!-- Input untuk gambar barcode -->
                                <label for="barcode_image">Upload Barcode Image</label>
                                <input type="file" name="barcode_image">
                            </div> --}}
                        </div>
                    </div>
                </div>
