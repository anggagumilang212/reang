                ...
                <div class="card-body">
                    <form wire:submit="generateReport">
                        ...
                        <div class="form-row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('messages.payment') }}</label>
                                    <select wire:model.live="payments" class="form-control" name="payments">
                                        <option value="">{{ __('messages.select_payment_method') }}</option>
                                        <option value="sale">{{ __('messages.sales') }}</option>
                                        <option value="sale_return">{{ __('messages.sales_returns') }}</option>
                                        <option value="purchase">{{ __('messages.purchases') }}</option>
                                        <option value="purchase_return">{{ __('messages.purchase_returns') }}</option>
                                    </select>
                                    @error('payments')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('messages.paymentmethod') }}</label>
