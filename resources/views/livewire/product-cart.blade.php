            ...
            <table class="table table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="align-middle text-center">{{ __('messages.net_unit_price') }}</th>
                        <th class="align-middle text-center">{{ __('messages.product_stock') }}</th>
                        <th class="align-middle text-center">{{ __('messages.quantity') }}</th>
                        <th class="align-middle text-center">{{ __('messages.discount') }}</th>
                        <th class="align-middle text-center">{{ __('messages.tax') }}</th>
                        ...
                        <tr>
                            <td colspan="8" class="text-center">
                                <span class="text-danger">
                                    Please {{ __('messages.search') }} & {{ __('messages.search_product') }}!
                                </span>
                            </td>
                        </tr>
                    @endif
        ...
        <div class="col-md-4">
            <div class="table-responsive">
                <table class="table table-striped">
                    <tr>
                        <th>{{ __('messages.tax') }} ({{ $global_tax }}%)</th>
    ...
    <div class="form-row">
        <div class="col-lg-4">
            <div class="form-group">
                <label for="tax_percentage">{{ __('messages.tax') }} (%)</label>
